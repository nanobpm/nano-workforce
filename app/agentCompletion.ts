 ...
 *  the HUMAN completer accepts it (issue #216). */
export const CONFORMANCE_ESCALATION_TASK_ELEMENT = "conformance-escalation";
...
const ESCALATION_FORM_BY_ELEMENT: Readonly<Record<string, string>> = {
  ...
  "conformance-escalation": "conformance-escalation",
};
